...
- [Agent QA](https://github.com/vostride/agent-qa) - 一款源码可用的工具，可运行自然语言编写的 Web 和移动端测试，并提供仪表板、命令行界面、执行记忆和 UI 适应能力。
- [Datasette](https://datasette.io/) - 一个用于探索和发布数据的工具，帮助人们处理任何形式的数据，进行分析和探索，并将其发布为交互式网站和配套的 API。面向数据记者、研究人员、科学家以及任何想要分享结构化数据的人。功能包括探索性数据分析、即时数据发布、使用 JSON API 进行快速原型开发，以及拥有 44 个工具和 154 个插件的丰富生态系统。
...
- [Launch Shots](https://www.launchshots.com/) - 最通用的截图编辑器，可在几秒钟内为你的应用商店列表创建令人惊艳的专业视觉效果。功能包括数百个专业设计的模板（原创和社区模板）、强大的图层管理、阴影、背景、设备框架、AI 本地化（100+ 种语言）、适用于 App Store 和 Play Store 的高质量导出、专用应用页面以及每周模板更新。免费使用，每月 3 个积分，包含所有功能。
