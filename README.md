...
- [PicSharp](https://github.com/AkiraBit/PicSharp) - A modern, full-featured, high-performance, cross-platform image compression application. Built with Tauri (Rust + TypeScript), it offers both offline compression and TinyPNG integration. Features include batch processing, format conversion, clipboard support, Finder Services menu (Mac), automatic compression mode, and rich configuration options. Supports PNG, JPEG, WebP, AVIF, TIFF, GIF, and SVG formats.
...
- [Agent QA](https://github.com/vostride/agent-qa) - A source-available tool for running natural-language web and mobile tests, with a dashboard, CLI, execution memory, and UI adaptation.
...
- [PaddleOCR](https://github.com/PaddlePaddle/PaddleOCR) - A powerful, lightweight OCR toolkit that bridges the gap between images/PDFs and LLMs. Turn any PDF or image document into structured data for your AI. Supports 100+ languages with high accuracy text recognition, document layout analysis, table recognition, and key information extraction. Features include PP-OCRv5 for text recognition, PP-StructureV3 for document parsing, and PP-ChatOCRv4 for intelligent document understanding.
